...
namespace InfinityCode.RealWorldTerrain.Generators
{
    ...
    {
        private const string server = "https://e4ftl01.cr.usgs.gov/MEASURES/SRTMGL1.003/2000.02.11/";
        ...
        public static void Init()
        {
            ...
            double dsx = Math.Abs(prefs.depthSharpness) * rangeX / (prefs.heightmapResolution - 1) / prefs.terrainCount.x;
